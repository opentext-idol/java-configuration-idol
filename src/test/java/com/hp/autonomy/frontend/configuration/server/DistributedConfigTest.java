...
import com.hp.autonomy.frontend.testing.matchers.SetContainingItems;
...
public class DistributedConfigTest extends ConfigurationComponentTest<DistributedConfig> {
    ...
    public void setUp() {
        ...
        Mockito.lenient().when(processorFactory.getResponseDataProcessor(GetVersionResponseData.class))
                .thenReturn(getVersionProcessor);
    }
